    ...
    <section id='hero'>
      <div className='container'>
        <article className='info-details'>
          ...
          <a href="https://tinyurl.com/2p8jfeyd" target='_blank' data-aos="fade-right" data-aos-easing="ease" data-aos-delay="400" className='btn-call-me'>
          ...
          <article className='social-media'>
            ...
            <div className='icons-social-media'>
              ...
              <article className='whatsapp'>
                ...
                <a href="https://tinyurl.com/2p8jfeyd" target='_blank' rel="noopener noreferrer">
